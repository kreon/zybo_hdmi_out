...
# Path of this script: C:\Xil_prj\hdmi_out\hdmi_out.vts\hdmi_out_system\_ide\scripts\systemdebugger_hdmi_out_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Xil_prj\hdmi_out\hdmi_out.vts\hdmi_out_system\_ide\scripts\systemdebugger_hdmi_out_system_standalone.tcl
# 
