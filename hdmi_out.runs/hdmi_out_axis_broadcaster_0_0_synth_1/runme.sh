...
HD_PWD='C:/Xil_prj/hdmi_out/hdmi_out.runs/hdmi_out_axis_broadcaster_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_out_axis_broadcaster_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_out_axis_broadcaster_0_0.tcl
